            ...
            <div class="col justify-content-center">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method="GET" action="{{url('projects/supplies')}}" class="input-group elements-login" style="margin-bottom: 15px;">
                        ...
                        <div class="col details">
                            ...
                            {{--
                                                                <div class="col-md-3 col-6 mb-1"><input class="btn-status orange" onclick="window.location.href ='{{url('projects/supplies?search=pendiente')}}'" type="button" value="Pendiente"></div>
                                <div class="col-md-3 col-6 mb-1"><input class="btn-status green" onclick="window.location.href ='{{url('projects/supplies?search=proceso')}}'"  type="button" value="En Proceso"></div>
                                <div class="col-md-3 col-6 mb-1"><input class="btn-status yellow" onclick="window.location.href ='{{url('projects/supplies?search=terminado')}}'" type="button" value="Terminado"></div>
                                <div class="col-md-3 col-6 mb-1"><input class="btn-status red" onclick="window.location.href ='{{url('projects/supplies?search=cancelado')}}'" type="button" value="Cancelado"></div>
                            --}}
                            </div>
                        </div>
                        <br>
